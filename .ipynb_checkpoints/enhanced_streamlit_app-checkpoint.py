...
if tab == "💬 Chat":
    ...
    if "quick_action" in st.session_state and st.session_state.quick_action:
        ...
        st.rerun() # Rerun to display the pre-filled prompt and get AI response
        # note: if you use st.experimental_rerun() it won't work with the recent version of streamlit!!!
    ...
    try:
        ...
        with col1:
            if not orders_df.empty:
                ...
                status_counts.index = status_counts.index.str.replace('_', ' ').str.title()
                fig_status = px.pie(
                ...
                st.info("No order data is avaliable for status distribution!")
        ...
        if not feedback_df.empty:
            ...
            column_renames = {'order_id': 'Order ID',
